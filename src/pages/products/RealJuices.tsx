          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-up">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Authentic fruit goodness in beautiful gift packaging. Perfect
                for sharing joy and health with your loved ones.
              </p>
            ...
            <div className="animate-scale-in">
              <img
                ...
                className="w-full h-[600px] object-cover rounded-lg shadow-premium"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <Card className="text-center hover-lift bg-gradient-card border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Premium 1L bottles in book-style packaging
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover-lift bg-gradient-card border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Family-sized bucket with assorted flavors
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover-lift bg-gradient-card border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Mixed sizes perfect for families
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover-lift bg-gradient-card border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Convenient carry pack with handle
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover-lift bg-gradient-card border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Compact gift box with 180ml bottles
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20 bg-gradient-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            Each Real Juice pack is crafted with authentic fruit flavors and
            packed with love to bring real moments of joy to your celebrations.
          </p>
