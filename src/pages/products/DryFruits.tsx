...
export default function DryFruits() {
  ...
  const filteredProducts = dryFruitsBoxes
    .filter(product => filterGrade === "all" || product.grade === filterGrade)
    .sort((a, b) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-up">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Finest quality cashews, almonds, pistachios, and more - carefully selected 
                and beautifully packaged for your special occasions.
              </p>
            ...
            {filteredProducts.map((product, index) => (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-primary mb-2">Contents:</h4>
      ...
      <section className="py-20 bg-gradient-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            Every dry fruit is carefully selected, quality-tested, and packed with love to ensure 
