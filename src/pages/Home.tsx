...
import { ArrowRight, Star, Shield, Truck, Clock, Gift, CheckCircle } from "lucide-react";
...
const whyChooseUs = [
  {
    ...
    description: "Only the finest ingredients and materials for superior taste and freshness"
  },
  {
    icon: Gift,
    title: "Expert Packaging",
    description: "Beautiful, professional packaging that makes every gift special"
  },
  {
    icon: Truck,
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-3xl text-white">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-up">
              Premium Gift-Packs & 
              <span className="text-premium block mt-2">Festive Corporate Gifting</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover our most popular gift collections, perfect for every celebration
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredProducts.map((product, index) => (
              ...
              >
                ...
                <CardHeader>
                  <CardTitle className="text-industrial">{product.name}</CardTitle>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-primary mb-4">Why Choose NGS Mart?</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We're committed to delivering exceptional quality and service for all your gifting needs
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-white/90">
              Secure your festive gifts early! Pre-booking is open from 12 September to 18 October 2025.
              Get the best selection and ensure availability for your celebrations.
            </p>
